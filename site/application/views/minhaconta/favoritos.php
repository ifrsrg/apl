<script type="text/javascript" src="{live}/media/front/js/minhaconta/favoritos.js"></script>
<div class="pagination">
    <ul>
        ...
        <li class="td-acoes excluir-favoritos"><a href="javascript:void(0);" alt="Excluir" title="Excluir"><img src="{live}/media/front/img/bt-excluir.png" alt="Excluir" title="Excluir"></a></li>
        <li>Ações</li>
    </ul>
    <br class="clear" />
    </div>
    <table cellpadding="0" cellspacing="0" class="table-default-mod">
            <thead>
                    <tr>
                            ...
                            <th width="14%" class="{ordem_classificados} {active_classificados}"><a href="javascript:void(0);" class="js-ordenacao-minha-conta" lang="classificados">Classificados</a></th>
                            ...
                            <th width="19%" class="{ordem_data} {active_data}"><a href="javascript:void(0);" class="js-ordenacao-minha-conta" lang="data">Data de Criação</a></th>
                            <th width="19%" class="{ordem_data_expiracao} {active_data_expiracao}"><a href="javascript:void(0);" class="js-ordenacao-minha-conta" lang="data_expiracao">Data de Expiração</a></th>
                    </tr>
            </thead>
        <tbody>
            <!-- BEGIN ANUNCIO -->
            <tr {classe_odd}>
                ...
                <td class="options">
                    <ul>
                        <li class="checkbox"><input type="checkbox" name="favoritos" value="{id_favoritos}" /></li>
                    </ul>
                </td>
                <td>{classificados}</td>
                <td class="active td-anuncio">				
					<a href="{live}/carros/anuncio/acao/ver/id/{id_anuncio}" title="">{anuncio}</a>
				</td>
                <td>{data}</td>
            ...
            <!-- BEGIN SEM_RESULTADO -->
            <br>
            <h2>Não há favoritos cadastrados para este filtro.</h2>
            <!-- END SEM_RESULTADO -->
    <div class="pagination">
    <ul>
            <li class="next"><a class="bt-paginacao-minha-conta" href="javascript:void(0);" pag="{pag_prox}">Próxima</a></li>
