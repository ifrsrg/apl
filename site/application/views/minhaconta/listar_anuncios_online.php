...
<div class="box-alert">
	<span class="icon-i"> </span> <p> Você possui <strong> 2 notificações </strong> pendentes. </p> <a href="#" class="icon-fechar"> Fechar </a>
</div>

<div class="pagination f-left aviso">
	<span class="obs">Selecione os itens desejados e clique nos botões Ativar ou Desativar</span>
    <ul>
    <!--
    ...
    -->
        ...
        <!-- BEGIN ACAO_EDITAR -->
        <li class="td-acoes editar"><a href="anunciosOnlineCarros" alt="Editar" title="Editar"><img src="{live}/media/front/img/bt-editar.png" alt="Editar" title="Editar"></a></li>
        <!-- END ACAO_EDITAR -->
        <li>Ações</li>
    </ul>
    <!--  <br class="clear" />   -->
    ...
    <table cellpadding="0" cellspacing="0" class="table-default-mod">
            <thead>
                    <tr>
                            ...
                            <!-- BEGIN FIELD_PLACA -->
                            <th width="11%" class="{ordem_placa} {active_placa}"><a href="javascript:void(0);" class="js-ordenacao-minha-conta" lang="placa">Placa</a></th>
                            <!-- END FIELD_PLACA -->
