...
(function(e, t) {
    ...
    var n = function() {
        ...
        this.setup = function() {
            ...
            this.opts.keys && e(document)
                .keydown(this.keys);
            this.opts.dots && this.dots();
            if (this.opts.fluid) {
                var r = function() {
                    n.el.css("width", Math.min(Math.round(n.el.outerWidth() / n.el.parent()
                        .outerWidth() * 100), 100) + "%")
                };
                r();
                e(window)
            ...
            if (this.opts.arrows) {
                this.el.parent()
                    .append('<div class="arrows"><button class="prev">&lang;</button><button class="next">&rang;</button></div>')
                    .find(".arrows button")
                    .click(function() {
            ...
            if (e.event.swipe) {
                this.el.on("swipeleft", n.prev)
                    .on("swiperight", n.next)
            }
        };
