<?php
class Controller_FornecedorCategoria extends ControllerAdmin {

		private $controller_name = "fornecedor_categoria",
		$url_path = "fornecedor-categoria",
		$model_name = "fornecedor_categoria",
		$id_field = "id_fornecedor_categoria",
		$titulo_pagina = "Categorias de Fornecedores",
		
		$column_label = array("ID","Nome"),
		$column_fields = array("id_fornecedor_categoria","nome"),
		$field_set = array("id_fornecedor_categoria","nome");
