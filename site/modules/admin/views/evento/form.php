...
<tr>
	...
	<td>
		...
		<tr>
			...
			<td>
				<input type="text" name="nome" value="{nome}" required label="Nome" valido="{valido}" maxlength='150' class="inp-form" />
			</td>
			<td></td>
		</tr>
		<tr>
			...
			<td>
				<input type="date-input" name="data" value="{data}" required="required" label="Data" valido="{valido}" maxlength='15' class="inp-form" />
			</td>
			<td></td>
		</tr>
		<tr>
			...
			<td>
				<input type="text" name="hora" value="{hora}" required="required" label="Hora" maxlength='100' class="inp-form" />
			</td>
			<td></td>
		</tr>
		<tr>
		...
		<tr>
			<th valign="top">Programa:</th>
			<td>
				<textarea editor name="programa">
					{programa}
				</textarea>
			</td>
			<td></td>
		...
		<tr>
			<th valign="top">Palestrantes:</th>
			<td>
				<textarea editor name="palestrantes">
					{palestrantes}
				</textarea>
			</td>
			<td></td>
		...
		<tr>
			<th valign="top">Informações Gerais:</th>
			<td>
				<textarea editor name="informacoes_gerais">
					{informacoes_gerais}
				</textarea>
			</td>
			<td></td>
		...
		<tr>
			<th valign="top">Texto Chamada:</th>
			<td>
				<input type="text" name="texto_lista" value="{texto_lista}" required="required" label="Local" maxlength='150' class="inp-form" />
			</td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Parceiros:</th>
			<td>
				<textarea editor name="parceiros">
					{parceiros}
				</textarea>
			</td>
			<td></td>
		...
		<tr>
			<th valign="top">Local:</th>
			<td>
				<input type="text" name="local" value="{local}" required="required" label="Local" maxlength='255' class="inp-form" />
			</td>
			<td></td>
		</tr>
		<tr>
			<th valign="top">Como Chegar:</th>
			<td>
		...
		<tr>
			<th valign="top">Fotos do Evento:</th>
			<td>
				<imageupload
				multiple
				required
