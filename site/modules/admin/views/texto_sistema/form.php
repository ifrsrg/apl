...
<form action="{live}/admin/texto-sistema/acao/salvar" method="post" accept="multipart/form-data" id="form-texto-sistema">
	<input type="hidden" name="id" value="{id_texto_sistema}" />
...
<tr>
	...
	<td>
		...
		<tr>
			<th valign="top">Chave:</th>
			<td>
				<input type="text" name="chave" value="{chave}" required label="Chave" valido="{valido}" maxlength='255' class="inp-form" />
			</td>
			<td></td>
		</tr>
		<tr>
			...
			<td>
			<textarea name='texto' required label="Texto" editor>
			{texto}
			</textarea>
			</td>
			<td></td>
