<div>
	...
	<div class="crud-toolbar">
		<a href="{live}/admin/cadastro/diversos/subcategoria/acao/adicionar">Adicionar</a>
		<div class="clear"></div>
	</div>
	<div class="clear"></div>
</div>
...
<tr>
	...
	<div id="content-table-inner">
		...
		<div id="table-content">
			Veja na listagem abaixo subcategorias de anúncio.<br/><br/>
			...
			<tr>
				...
				<a href="{live}/admin/cadastro/diversos/subcategoria/acao/editar/id/{id_subcategoria}" title="Editar" class="icon-1 info-tooltip"></a>
				<a href="{live}/admin/cadastro/diversos/subcategoria/acao/status/id/{id_subcategoria}" title="Alterar Status" class="icon-1 info-tooltip"></a>
				<a href="{live}/admin/cadastro/diversos/subcategoria/acao/deletar/id/{id_subcategoria}" title="Apagar" class="icon-2 info-tooltip"></a>
				</td>
			</tr>
			<!-- END LISTAR -->
			</table> 
