<script type="text/javascript" src="{live}/media/admin/js/cadastro/diversos/subcategoria/form.js"></script>
...
<form action="{live}/admin/cadastro/diversos/subcategoria/acao/salvar" method="post" accept="multipart/form-data" id="form-subcategoria">
	<input type="hidden" name="id" value="{id_subcategoria}" />
...
<tr>
	...
	<td>
		...
		<tr>
			...
			<td>
				<select class="inp-form" name="id_categoria">
					<option value="">Selecione</option>
					<!-- BEGIN CATEGORIA -->
		...
		<tr>
			...
			<td><input type="text" name="subcategoria" value="{subcategoria}" id="subcategoria" class="inp-form" /><td>
			</td>
		</tr>
		<tr>
