<script type="text/javascript" src="{live}/media/admin/js/cadastro/diversos/categoria/form.js"></script>
...
<form action="{live}/admin/cadastro/diversos/categoria/acao/salvar" method="post" accept="multipart/form-data" id="form-beneficio">
...
<tr>
	...
	<td>
		...
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
			...
			<td>
                            <select class="inp-form" name="id_segmento">
		...
		<tr>
			...
			<td><input type="text" name="categoria" value="{categoria}" id="categoria" class="inp-form" /></td>
			<td>
			</td>
		</tr>
		<tr>
