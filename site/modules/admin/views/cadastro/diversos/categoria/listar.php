<div>
	<div class="crud-heading">
		<h3>Diversos - Categoria</h3>
		<h4>Lista</h4>
	</div>
	<div class="crud-toolbar">
		<a href="{live}/admin/cadastro/diversos/categoria/acao/adicionar">Adicionar</a>
		<div class="clear"></div>
	</div>
	<div class="clear"></div>
</div>
...
<tr>
	...
	<div id="content-table-inner">
		...
		<div id="table-content">
			Veja na listagem abaixo categorias de anúncio.<br/><br/>
			...
			<tr>
				...
				<a href="{live}/admin/cadastro/diversos/categoria/acao/editar/id/{id_categoria}" title="Editar" class="icon-1 info-tooltip"></a>
				<a href="{live}/admin/cadastro/diversos/categoria/acao/status/id/{id_categoria}" title="Alterar Status" class="icon-1 info-tooltip"></a>
				<a href="{live}/admin/cadastro/diversos/categoria/acao/deletar/id/{id_categoria}" title="Apagar" class="icon-2 info-tooltip"></a>
				</td>
			</tr>
			<!-- END LISTAR -->
			</table> 
