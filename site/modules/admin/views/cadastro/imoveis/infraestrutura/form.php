<script type="text/javascript" src="{live}/media/admin/js/cadastro/imoveis/infraestrutura/form.js"></script>
...
<form action="{live}/admin/cadastro/imoveis/infraestrutura/acao/salvar" method="post" accept="multipart/form-data" id="form-imoveis-infraestrutura">
	<input type="hidden" name="id" value="{id_infraestrutura}" />
...
<tr>
	...
	<td>
		...
		<tr>
			<th valign="top">Infraestrutura:</th>
			<td><input type="text" name="imovel_infraestrutura" value="{imovel_infraestrutura}" id="imovel_infraestrutura" class="inp-form" /></td>
			<td>
			</td>
		</tr>
		<tr>
