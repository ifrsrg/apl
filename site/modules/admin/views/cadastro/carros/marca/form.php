<script type="text/javascript" src="{live}/media/admin/js/cadastro/carros/marca/form.js"></script>
...
<form action="{live}/admin/cadastro/carros/marca/acao/salvar" method="post" accept="multipart/form-data" id="form-marca">
	<input type="hidden" name="id_veiculo_marca" value="{id_veiculo_marca}" />
...
<tr>
	...
	<td>
		...
		<tr>
			...
			<td><input type="text" name="marca" value="{marca}" id="marca" class="inp-form" /></td>
			<td>
			</td>
		</tr>
		<tr>
			...
			<td>
				<select class="inp-form" name="id_veiculo_tipo">
					...
					<!-- BEGIN TIPO -->
					<option value="{num_tipo}" {selected_tipo}>{tipo}</option>
					<!-- END TIPO -->
				</select>
			</td>
			<td>
