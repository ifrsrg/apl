...
<form action="{live}/admin/cadastro/carros/acessorio/acao/salvar" method="post" accept="multipart/form-data" id="form-acessorio">
	<input type="hidden" name="id_veiculo_acessorio" value="{id_veiculo_acessorio}" />
...
<tr>
	...
	<td>
		...
		<tr>
			<th valign="top">Acessório:</th>
			<td><input type="text" name="acessorio" value="{acessorio}" id="marca" class="inp-form" /></td>
			<td>
			</td>
		</tr>
		<tr>
