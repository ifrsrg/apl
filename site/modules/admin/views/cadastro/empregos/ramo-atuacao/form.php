<script type="text/javascript" src="{live}/media/admin/js/cadastro/empregos/ramo-atuacao/form.js"></script>

<div>
	<div class="crud-heading">
		<h3>Emprego - Ramo de Atuação</h3>
...
<form action="{live}/admin/cadastro/empregos/ramo-atuacao/acao/salvar" method="post" accept="multipart/form-data" id="form-area-atuacao">
	<input type="hidden" name="id" value="{id_area_atuacao}" />
...
<tr>
	...
	<td>
		...
		<tr>
			<th valign="top">Ramo de Atuação:</th>
			<td><input type="text" name="area_atuacao" value="{area_atuacao}" id="area-atuacao" class="inp-form" /></td>
			<td>
			</td>
		</tr>
		<tr>
