<script type="text/javascript" src="{live}/media/admin/js/cadastro/empregos/beneficio/form.js"></script>

<div>
	<div class="crud-heading">
		<h3>Emprego - Benefício</h3>
...
<form action="{live}/admin/cadastro/empregos/beneficio/acao/salvar" method="post" accept="multipart/form-data" id="form-beneficio">
	<input type="hidden" name="id" value="{id_emprego_beneficio}" />
...
<tr>
	...
	<td>
		...
		<tr>
			<th valign="top">Benefício:</th>
			<td><input type="text" name="beneficio" value="{beneficio}" id="beneficio" class="inp-form" /></td>
			<td>
			</td>
		</tr>
		<tr>
