...
<tr>
	...
	<td>
		...
		<tr>
			...
			<td>
				<input type="email" name="email" value="{email}" required label="Email" valido="{valido}" maxlength='100' class="inp-form" />
			</td>
			<td></td>
		</tr>
		<tr>
			...
			<td>
				<select required name="id_email_categoria" label="Categoria">
