...
<tr>
	...
	<td>
		...
		<tr>
			...
			<td>
				<input type="text" name="nome" value="{nome}" required label="Nome" valido="{valido}" maxlength='255' class="inp-form" />
			</td>
			<td></td>
		</tr>
		<tr>
			...
			<td>
				<select name="id_download_categoria" required label="Categoria">
